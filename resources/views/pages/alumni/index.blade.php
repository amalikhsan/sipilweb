...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-header-action">
            <a href="{{ route('dataalumni.create') }}" class="btn btn-primary">
            ...
            var datatable = $('#datatable').DataTable({
                ...
                columnDefs: [{
                    ...
                    "render": function(data, type, row, meta) {
                        return `
                        ${data}
                        <form action="{{ url('/dataalumni') }}/${row.crypt_id}" method="POST" class="table-links">
                            @method('DELETE')
                            @csrf
                            <a
                                href="{{ url('/dataalumni') }}/${row.crypt_id}/edit"
                                class="btn btn-sm"
                            >
                                Edit
                            </a>
