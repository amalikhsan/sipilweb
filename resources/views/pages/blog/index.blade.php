...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-header-action">
            <a href="{{ route('datablog.create') }}" class="btn btn-primary">
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row, meta) {
                            return `
                        ${data}
                        <form action="{{ url('/datablog') }}/${row.crypt_id}" method="POST" class="table-links">
                            @method('DELETE')
                            @csrf
                            <a
                                href="{{ url('/datablog') }}/${row.crypt_id}/edit"
                                class="btn btn-sm"
                            >
                                Edit
                            </a>
