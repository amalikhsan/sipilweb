...
class DataAlumniController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $query = DataAlumni::with('user')->get();
    ...
    public function store(Request $request)
    {
        ...
        return redirect('dataalumni')->with('toast', 'showToast("Data berhasil disimpan")');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('dataalumni')->with('toast', 'showToast("Data berhasil diupdate")');
    }
